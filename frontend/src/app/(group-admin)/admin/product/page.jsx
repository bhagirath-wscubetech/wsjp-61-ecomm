                            ...
                            <tbody>
                                {products.map((product, index) => (
                                    <tr key={product.id}>
                                        ...
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <img width={100} src={`${process.env.NEXT_PUBLIC_BASE_URL}/images/product/${product.main_image}`} alt="" />
                                        </td>
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm text-right">
                                            <div className='flex gap-3'>
                                                ...
                                                <MultipleImage product_id={product._id} name={product.name} other_images={product.other_images} />
                                            </div>
                                        </td>
                                    </tr>
                                ))}
